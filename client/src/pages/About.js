...
export default function About() {
    return (
      <div>
        ...
        <MDBTypography className='lead mb-0'>
          <font size="3" face='sans-serif'>
            ...
            <p>Welcome to HealthSense, the ultimate e-healthcare website where we strive to provide the best possible experience to our users. Our platform offers a comprehensive range of healthcare services, including automated medical tests powered by state-of-the-art AI technology, live world medical insights, and personalized medical records management.</p>
            <p>At HealthSense, we understand the importance of efficient and convenient healthcare services, which is why we have developed a user-friendly platform that enables individuals to access healthcare services with ease. Our website features a simple and intuitive interface that allows users to create profiles and manage their health records effortlessly.</p>
          </font>
      </MDBTypography>

      <MDBAccordion initialActive={1}>
      <MDBAccordionItem collapseId={1} headerTitle='Health Profile'>
      ...
      <MDBAccordionItem collapseId={2} headerTitle='Automated AI Medical Diagnosis'>
      ...
      <MDBAccordionItem collapseId={3} headerTitle='Live Global Medical Insights on the Homepage'>
      ...
      <MDBAccordionItem collapseId={4} headerTitle='Health professionals can access user profiles to evaluate faster.'>
